    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14 flex flex-col gap-16 text-[#F5F3EE]">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start border-b border-[#222222] pb-14">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="mt-8 p-4 bg-[#121212] border border-[#262626] w-full max-w-lg">
            ...
            <div className="flex items-center gap-1.5 mt-3 pt-2.5 border-t border-[#1F1F1F] flex-wrap">
              <span className="text-[10px] font-mono text-[#666666] mr-1">LENCANA:</span>
                ...
                <button
                  ...
                  className={`px-2 py-0.5 text-[10px] font-mono transition border ${
                    selectedAvatar === badge
                      ...
                      : 'bg-[#171717] text-[#888884] border-[#2A2A2A] hover:text-[#F5F3EE] hover:border-[#444444]'
                  }`}
                >
                  {badge}
                </button>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 w-full max-w-lg">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-[#FF4D2E] hover:bg-[#ff6145] text-[#0A0A0A] font-bold py-3 px-5 text-sm tracking-wide transition transform active:translate-y-0.5"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-[#141414] hover:bg-[#1A1A1A] text-[#F5F3EE] border border-[#2C2C2C] text-sm font-mono px-4 py-3 transition"
            >
              <SlidersHorizontal className="w-3.5 h-3.5 text-[#888884]" />
              <span>NAMA KHAS</span>
            </button>
          </div>
          ...
          {isCreatingCustom && (
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#FF4D2E] hover:bg-[#ff6145] text-[#0A0A0A] font-bold px-4 py-2 text-xs tracking-wider"
              >
                MASUK
              </button>
            </form>
          ...
          <div className="mt-4 w-full max-w-lg">
            <form onSubmit={handleJoinExistingRoom} className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#121212] border border-[#262626] focus:border-[#A8E6CF] focus:outline-none px-3.5 py-2.5 text-xs font-mono text-[#F5F3EE] placeholder-[#666666]"
              />
              <button
                type="submit"
                disabled={!roomIdInput.trim()}
                className="px-4 py-2.5 bg-[#1C1C1C] hover:bg-[#252525] disabled:opacity-40 text-[#A8E6CF] border border-[#2E2E2E] transition flex items-center gap-1.5 font-mono text-xs"
              >
                <span>SERTAI</span>
        ...
        <div className="lg:col-span-5 bg-[#101010] border border-[#222222] p-5 sm:p-6 flex flex-col gap-4">
          <div className="flex items-center justify-between pb-3 border-b border-[#1E1E1E]">
            <div>
              <div className="text-[10px] font-mono tracking-widest text-[#888884] uppercase">
                SESI BERKUMPUL
              </div>
            ...
            {PRESET_ROOMS.map((preset) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <span className="font-editorial text-2xl text-[#555555] group-hover:text-[#FF4D2E] transition-colors w-7 leading-none">
                    {preset.index}
                  </span>
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-[10px] font-mono text-[#888884] uppercase">
                        {preset.genre}
                      </span>
                ...
                <div className="text-right">
                  <span className="text-[10px] font-mono text-[#888884] group-hover:text-[#A8E6CF] flex items-center gap-1 transition">
                    MASUK
                    <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
                  </span>
                  <span className="text-[9px] font-mono text-[#444444] block">#{preset.id}</span>
                </div>
              </div>
            ))}
          </div>

          <div className="pt-3 border-t border-[#1C1C1C] flex items-center justify-between text-[11px] font-mono text-[#666666]">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-7 bg-[#101010] border border-[#222222] p-6 sm:p-8 flex flex-col gap-4">
          ...
          <p className="text-sm text-[#999994] leading-relaxed">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-[#1C1C1C]">
            <div>
              <div className="text-[10px] font-mono text-[#666666] uppercase">LATENCY BUFFER</div>
              <div className="text-lg font-mono text-[#A8E6CF] font-bold mt-0.5">~18ms</div>
            </div>
            <div>
              <div className="text-[10px] font-mono text-[#666666] uppercase">AUDIO FORMAT</div>
              <div className="text-lg font-mono text-[#F5F3EE] font-bold mt-0.5">44.1kHz MP3</div>
            </div>
            <div>
              <div className="text-[10px] font-mono text-[#666666] uppercase">IKLAN AUDIO</div>
        ...
        <div className="lg:col-span-5 bg-[#121212] border border-[#262626] p-6 sm:p-8 flex flex-col justify-between gap-6">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs sm:text-sm text-[#888884] leading-relaxed">
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-[#202020]">
            <button
              onClick={onOpenDocs}
              className="flex-1 py-2.5 px-3 border border-[#333333] hover:border-[#555555] text-xs font-mono text-[#F5F3EE] transition text-center"
            >
              DOKUMENTASI
            </button>
            <button
              onClick={onOpenDonation}
              className="flex-1 py-2.5 px-3 bg-[#FF4D2E] hover:bg-[#ff6145] text-[#0A0A0A] font-bold text-xs font-mono transition text-center flex items-center justify-center gap-1.5"
            >
